...
print("Il y a eu ", nb_constru, "de constructeur en F1 entre 1950 et 2021 dont plus d'une trentaine n'ont jamais couru.")
...
def gen_csv():
    ...
    if os.path.exists('merge_race_result.csv'):
        ...
        print("\nle fichier 'merge_race_result.csv' n'a pas été généré\n")
    print('#############################################')
